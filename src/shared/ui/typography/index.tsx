...
import { BodyVariant, ButtonVariant, FieldVariant, HeadingVariant, TagVariant } from './lib/types'
...
export const Typography = ({
  ...
  return (
    <Tag className={classNames(getTypographyStyles(type, variant), className)} {...rest}>
      {children}
    </Tag>
  )
}
